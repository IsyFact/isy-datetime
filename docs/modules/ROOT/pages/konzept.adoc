...
|Zusätzliche Erkenntnis: Das Ereignis fand um Viertel nach 15 Uhr statt. |Start des Ereignisses: 15:15 – 15:15
|====
...
Diese Möglichkeit wird die Eingabe unbekannter Datums- oder Zeitbestandteile mittels Nullen mittelfristig ablösen und unterstützt Eingaben im ISO-8601 Datumsformat.
